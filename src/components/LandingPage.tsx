          ...
          <div className="relative z-10 p-8 md:p-12">
            ...
            <div>
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 max-w-5xl mx-auto">
                {/* Team leader — same row, subtly distinguished */}
                <li>
                  <div className="group relative flex items-center gap-3 p-4 rounded-xl bg-gradient-to-l from-[#c9a84c]/12 via-white/70 to-white/60 border-2 border-[#c9a84c]/50 hover:border-[#c9a84c] hover:shadow-md transition-all h-full">
                    <span className="shrink-0 w-9 h-9 rounded-lg bg-gradient-to-br from-[#c9a84c] to-[#a08131] text-[#1c120a] flex items-center justify-center shadow-sm group-hover:scale-105 transition-transform">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-[#c9a84c]/20 border border-[#c9a84c]/35 text-[10px] font-cairo font-bold text-[#a08131]">
                          <Crown size={9} />
                          قائدة الفريق
                        </span>
                      </div>
                ...
                {TEAM_CREATORS.map((name, index) => (
                  <li
                    key={name}
                    className={
                      index === TEAM_CREATORS.length - 1 && (TEAM_CREATORS.length + 1) % 2 === 1
